...
x_arrow = obj_matrixBorder.x + sprite_get_width(spr_matrixBorder) + sprite_get_width(spr_rightArrow)/2;
y_arrow = obj_matrixBorder.y + sprite_get_width(spr_rightArrow)/2;
